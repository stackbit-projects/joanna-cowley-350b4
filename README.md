...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/606350b4c84e4b0016936cee
...
To start editing your site, you can use the Sanity interface at https://joanna-cowley-350b4.sanity.studio/.
...
Generated at `2021-03-30T16:26:32.461Z` by Stackbit version `0.3.50`.